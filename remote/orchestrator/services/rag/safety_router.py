...
SUPPORT_TOPIC_KEYWORDS = {
    ...
    "depression": [
        "抑郁", "低落", "难过", "没兴趣", "无意义", "绝望", "不开心",
        "提不起劲", "不想碰", "饭量也差", "不想出门", "不想跟人说话",
    ],
    "bipolar_risk": [
        "亢奋", "躁", "双相", "情绪波动", "精力特别旺", "睡很少也不困",
        "只睡两三个小时也不困", "脑子特别快", "话特别多", "买很多没必要",
    ],
    "sleep": ["失眠", "睡不着", "早醒", "睡眠", "熬夜", "睡很少", "睡得少", "不困"],
    "stress": ["压力", "崩溃", "撑不住", "累", "学业", "工作"],
    "emotion_regulation": ["情绪", "烦躁", "调节", "放松", "呼吸"],
    "elderly_support": [
        "孤独", "老人", "退休", "一个人住", "一个人在家", "空落落",
        "女儿在外地", "陪伴", "家属", "照护",
    ],
    "support_strategy": ["怎么陪", "怎么安慰", "先别继续说建议", "总结一下"],
}
