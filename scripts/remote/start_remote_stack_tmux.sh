...
export AVATAR_RENDERER_BACKEND="${AVATAR_RENDERER_BACKEND:-echomimic_v3}"
...
export ECHOMIMIC_V3_ROOT="${ECHOMIMIC_V3_ROOT:-$A22_CODE/../echomimic_v3}"
export ECHOMIMIC_V3_PYTHON="${ECHOMIMIC_V3_PYTHON:-$A22_ENV_ROOT/echomimic-v3/bin/python}"
export ECHOMIMIC_V3_INFER_SCRIPT="${ECHOMIMIC_V3_INFER_SCRIPT:-infer_flash.py}"
export ECHOMIMIC_V3_CONFIG_PATH="${ECHOMIMIC_V3_CONFIG_PATH:-config/config.yaml}"
export ECHOMIMIC_V3_MODEL_PATH="${ECHOMIMIC_V3_MODEL_PATH:-$A22_MODEL_ROOT/echomimic_v3_flash/Wan2.1-Fun-V1.1-1.3B-InP}"
export ECHOMIMIC_V3_TRANSFORMER_PATH="${ECHOMIMIC_V3_TRANSFORMER_PATH:-$A22_MODEL_ROOT/echomimic_v3_flash/flash/transformer/diffusion_pytorch_model.safetensors}"
export ECHOMIMIC_V3_WAV2VEC_PATH="${ECHOMIMIC_V3_WAV2VEC_PATH:-$A22_MODEL_ROOT/echomimic_v3_flash/flash/chinese-wav2vec2-base}"
export ECHOMIMIC_V3_TIMEOUT_SECONDS="${ECHOMIMIC_V3_TIMEOUT_SECONDS:-3600}"
export ECHOMIMIC_V3_WIDTH="${ECHOMIMIC_V3_WIDTH:-768}"
export ECHOMIMIC_V3_HEIGHT="${ECHOMIMIC_V3_HEIGHT:-768}"
export ECHOMIMIC_V3_FPS="${ECHOMIMIC_V3_FPS:-25}"
export ECHOMIMIC_V3_STEPS="${ECHOMIMIC_V3_STEPS:-8}"
export ECHOMIMIC_V3_MAX_FRAMES="${ECHOMIMIC_V3_MAX_FRAMES:-201}"
export ECHOMIMIC_V3_GUIDANCE_SCALE="${ECHOMIMIC_V3_GUIDANCE_SCALE:-6.0}"
export ECHOMIMIC_V3_AUDIO_GUIDANCE_SCALE="${ECHOMIMIC_V3_AUDIO_GUIDANCE_SCALE:-3.0}"
export ECHOMIMIC_V3_GPU_MEMORY_MODE="${ECHOMIMIC_V3_GPU_MEMORY_MODE:-sequential_cpu_offload}"
...
export ECHOMIMIC_V3_REF_IMAGE_PATH="${ECHOMIMIC_V3_REF_IMAGE_PATH:-$SOULX_REF_IMAGE_PATH}"
...
if [ "$AVATAR_RENDERER_BACKEND" = "echomimic_v3" ]; then
  for required_path in \
    "$ECHOMIMIC_V3_ROOT/$ECHOMIMIC_V3_INFER_SCRIPT" \
    "$ECHOMIMIC_V3_PYTHON" \
    "$ECHOMIMIC_V3_TRANSFORMER_PATH"; do
    if [ ! -e "$required_path" ]; then
      echo "[error] missing EchoMimicV3 asset: $required_path" >&2
      exit 1
    fi
  done
fi
...
export ECHOMIMIC_V3_ROOT=\"$ECHOMIMIC_V3_ROOT\"
export ECHOMIMIC_V3_PYTHON=\"$ECHOMIMIC_V3_PYTHON\"
export ECHOMIMIC_V3_INFER_SCRIPT=\"$ECHOMIMIC_V3_INFER_SCRIPT\"
export ECHOMIMIC_V3_CONFIG_PATH=\"$ECHOMIMIC_V3_CONFIG_PATH\"
export ECHOMIMIC_V3_MODEL_PATH=\"$ECHOMIMIC_V3_MODEL_PATH\"
export ECHOMIMIC_V3_TRANSFORMER_PATH=\"$ECHOMIMIC_V3_TRANSFORMER_PATH\"
export ECHOMIMIC_V3_WAV2VEC_PATH=\"$ECHOMIMIC_V3_WAV2VEC_PATH\"
export ECHOMIMIC_V3_REF_IMAGE_PATH=\"$ECHOMIMIC_V3_REF_IMAGE_PATH\"
export ECHOMIMIC_V3_TIMEOUT_SECONDS=\"$ECHOMIMIC_V3_TIMEOUT_SECONDS\"
export ECHOMIMIC_V3_WIDTH=\"$ECHOMIMIC_V3_WIDTH\"
export ECHOMIMIC_V3_HEIGHT=\"$ECHOMIMIC_V3_HEIGHT\"
export ECHOMIMIC_V3_FPS=\"$ECHOMIMIC_V3_FPS\"
export ECHOMIMIC_V3_STEPS=\"$ECHOMIMIC_V3_STEPS\"
export ECHOMIMIC_V3_MAX_FRAMES=\"$ECHOMIMIC_V3_MAX_FRAMES\"
export ECHOMIMIC_V3_GUIDANCE_SCALE=\"$ECHOMIMIC_V3_GUIDANCE_SCALE\"
export ECHOMIMIC_V3_AUDIO_GUIDANCE_SCALE=\"$ECHOMIMIC_V3_AUDIO_GUIDANCE_SCALE\"
export ECHOMIMIC_V3_GPU_MEMORY_MODE=\"$ECHOMIMIC_V3_GPU_MEMORY_MODE\"
